...
Usage:
  For MNIST:
    python FMGM_uncond.py --epochs 20 --checkpoint_interval 5 --batch_size 64 --learning_rate 2e-3 --dataset mnist
  For CIFAR10:
    python FMGM_uncond.py --epochs 20 --checkpoint_interval 5 --batch_size 64 --learning_rate 1e-4 --dataset cifar10
"""
